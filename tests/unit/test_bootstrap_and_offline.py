...
class OfflineBundleTests(unittest.TestCase):
    ...
    def test_partial_bundle_is_private_self_describing_and_installable(self) -> None:
        ...
        with zipfile.ZipFile(result["archive"]) as archive:
            ...
            self.assertIn("ArchitectPass-offline/project/scripts/prepare_downloaded_materials.py", names)
            self.assertIn("ArchitectPass-offline/project/scripts/runtime_health_snapshot.py", names)
