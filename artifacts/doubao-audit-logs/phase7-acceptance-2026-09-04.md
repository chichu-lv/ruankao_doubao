...
Under `request_id=phase7-cheko-rule-001` and `audit_id=phase7-cheko-rule-audit-001`, the saved rule `AP-J1-计算机网络基线-v1` was configured for 20 questions; 6 easy, 10 medium and 4 hard; unattempted-first; only computer-network knowledge; only second-edition and must-master labels; and 2025-05, 2024-11, 2024-05, 2023-11 and 2022-11. The user's reported 2025-11 and 2026-05 sittings were excluded to reduce direct familiarity. The UI returned to the rule list, displayed the exact saved name and enabled `出题`, which was not clicked. No paper, question, answer, mastery state or checkpoint was created.
